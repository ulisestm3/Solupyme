...
<body>
    <div class="container">
        ...
        <?php if ($mensaje): ?>
            <div class="mensaje-modal" id="mensajeModal">
                <div class="mensaje-contenido success">
                    ...
                    <div class="mensaje-texto"><?= htmlspecialchars($mensaje) ?></div>
                    <button class="mensaje-cerrar" onclick="document.getElementById('mensajeModal').style.display='none';">Cerrar</button>
                </div>
            </div>
        <?php endif; ?>


<h3>Categorías de Productos</h3> <br>

<button class="btn" onclick="mostrarModal()">Agregar Categoría</button>
...
<table>
    ...
    <?php foreach ($categorias as $c): ?>
        <tr>
            ...
            <td>
                <a href="editar_categoria.php?id=<?= $c['idcategoria'] ?>">Editar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
