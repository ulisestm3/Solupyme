...
<head>
    ...
    <title>Costo de Productos</title>
...
<body>
    <div class="container">
        ...
        <main class="main-content">
            <h3><i class="fas fa-dollar-sign"></i> Costo de Productos</h3>
                    ...
                    <?php if (!empty($registros)): ?>
                        <?php foreach ($registros as $fila): ?>
                            <tr class="fila-registro">
                                ...
                                <td><?= intval($fila['stock']) ?></td>
                                <td><?= number_format($fila['promedio_precio'], 2) ?></td>
                                <td style="color: #dc3545; font-weight: bold;"><?= number_format($fila['costo_producto'], 2) ?></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
